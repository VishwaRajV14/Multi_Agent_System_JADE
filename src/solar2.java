...
public class solar2 extends Agent
{
    int[] solar2_KW={167};
    int[] solar2_price={7};//per unit KW
    int i=0;
    int count=0;
    @Override
        ...
        public void action()
        {
            ...
            if(msg!=null)
            {
                if (msg.getPerformative() == ACLMessage.CFP)
                {
                    ...
                    String temp = Integer.toString(solar2_KW[i]);
                    String temp1=Integer.toString(solar2_price[i]);
                ...
                else if (msg.getPerformative() == ACLMessage.ACCEPT_PROPOSAL)
                {
                    ...
                    {
                        solar2_KW[i] = solar2_KW[i] - Integer.parseInt(msg.getContent());
                    }
                    else if(msg.getSender().getLocalName().equals("load2"))
                    {
                        i++;
                        count=0;
                        if (i == solar2_KW.length)
                        {
                            //resetting to initial values
                            //the values given in the solar2_KW[] have to be given here again
                            i=0;
                            solar2_KW[0]=167;
                           // solar1_KW[1]=20;
                           // solar1_KW[2]=30;
